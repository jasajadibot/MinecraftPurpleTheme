...
installTheme(){
    ...
    git clone https://github.com/jasajadibot/MinecraftPurpleTheme.git
...
repair(){
    bash <(curl https://raw.githubusercontent.com/jasajadibot/MinecraftPurpleTheme/main/repair.sh)
}
